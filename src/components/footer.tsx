      ...
      <div className="container mx-auto relative z-10 grid grid-cols-1 gap-10 px-4 sm:px-6 md:grid-cols-4 md:gap-8">
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-slate-400 font-medium">
            ...
            <li>
              <Link href="/certificates" className="transition-colors hover:text-white">
                Certificates
              </Link>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-4 text-sm text-slate-400">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="mailto:jayvirsinh@mmvalves.com" className="transition-colors hover:text-white font-medium">
                jayvirsinh@mmvalves.com
              </a>
            </li>
            <li className="flex items-center gap-3">
              <Phone className="h-5 w-5 shrink-0 text-red-500" />
              <a href="tel:+919429546918" className="transition-colors hover:text-white font-medium">
                +91 9429546918
              </a>
            </li>
          </ul>
